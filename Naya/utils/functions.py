...
from Naya import aiohttpsession as aiosession
from Naya.utils.dbfunctions import start_restart_stage
from Naya.utils.http import get, post
...
def generate_captcha():
    ...
    height = 100
    correct_answer = ""
    font = ImageFont.truetype("Naya/resources/fonts/arial.ttf", 55)
    file = f"Naya/resources/{randint(1000, 9999)}.jpg"
