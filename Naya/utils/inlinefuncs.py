...
from Naya.core.tasks import _get_tasks_text, all_tasks, rm_task
from Naya.modules.info import get_chat_info, get_user_info
from Naya.modules.music import download_youtube_audio
from Naya.utils.functions import test_speedtest
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph//file/a38635176bcf93b83053f.jpg",
        ...
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent(
                "https://github.com/naya1503/NayaRobot"
            ),
            thumb_url="https://telegra.ph//file/a38635176bcf93b83053f.jpg",
        ),
    ]
...
async def alive_function(answers):
    ...
    msg = f"""
**[ɴλʏʌ ᴍᴜsɪᴄ ꝛσʙσᴛ](https://github.com/naya1503/NayaRobot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
