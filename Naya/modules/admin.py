...
from Naya import BOT_ID, SUDOERS, app, log
...
from Naya.utils.functions import (
    extract_user,
...
@app.on_message(filters.command("zombie") & ~filters.private)
@adminsOnly("can_restrict_members")
