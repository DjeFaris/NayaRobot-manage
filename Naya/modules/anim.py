...
async def _(client: Client, message: Message):
    ...
    await eor(message, text=reply_text)
...
@app.on_message(filters.command("hmm"))
async def hello_world(client: Client, message: Message):
    mg = await eor(message, text=
        "┈┈╱▔▔▔▔▔╲┈┈┈HM┈HM\n┈╱┈┈╱▔╲╲╲▏┈┈┈HMMM\n╱┈┈╱━╱▔▔▔▔▔╲━╮┈┈\n▏┈▕┃▕╱▔╲╱▔╲▕╮┃┈┈\n▏┈▕╰━▏▊▕▕▋▕▕━╯┈┈\n╲┈┈╲╱▔╭╮▔▔┳╲╲┈┈┈\n┈╲┈┈▏╭━━━━╯▕▕┈┈┈\n┈┈╲┈╲▂▂▂▂▂▂╱╱┈┈┈\n┈┈┈┈▏┊┈┈┈┈┊┈┈┈╲\n┈┈┈┈▏┊┈┈┈┈┊▕╲┈┈╲\n┈╱▔╲▏┊┈┈┈┈┊▕╱▔╲▕\n┈▏┈┈┈╰┈┈┈┈╯┈┈┈▕▕\n┈╲┈┈┈╲┈┈┈┈╱┈┈┈╱┈╲\n┈┈╲┈┈▕▔▔▔▔▏┈┈╱╲╲╲▏\n┈╱▔┈┈▕┈┈┈┈▏┈┈▔╲▔▔\n┈╲▂▂▂╱┈┈┈┈╲▂▂▂╱┈ ",
    )


@app.on_message(filters.command("ahh"))
async def hello_world(client: Client, message: Message):
    mg = await eor(message, text="ahh")
...
@app.on_message(filters.command("wtf"))
...
@app.on_message(filters.command("hypo"))
...
@app.on_message(filters.command("charging"))
...
@app.on_message(filters.command("kocok"))
async def kocok(client: Client, message: Message):
    e = await eor(message, text="8✊===D")
    await e.edit("8=✊==D")
    await e.edit("8==✊=D")
    await e.edit("8===✊D")
    await e.edit("8==✊=D")
...
@app.on_message(filters.command(["kontol", "kntl"]))
...
@app.on_message(filters.command(["penis", "dick"]))
...
@app.on_message(filters.command("dino"))
async def adadino(client: Client, message: Message):
    typew = await eor(message, text="`DIN DINNN.....`")
    await asyncio.sleep(1)
...
@app.on_message(filters.command("gabut"))
async def menggabut(client: Client, message: Message):
    e = await eor(message, text="`PERNAAHHHHH KAHHH KAUUU MENGIRA`")
...
@app.on_message(filters.command("tembak"))
...
@app.on_message(filters.command("bundir"))
...
@app.on_message(filters.command("awk"))
...
@app.on_message(filters.command("tank"))
...
@app.on_message(filters.command("babi"))
...
@app.on_message(filters.command("ajg"))
...
@app.on_message(filters.command("nah"))
async def nahlove(client: Client, message: Message):
    typew = await eor(message, text="`\n(\\_/)`" "`\n(●_●)`" "`\n />💖 *Ini Buat Kamu`")
    await asyncio.sleep(2)
    await typew.edit("`\n(\\_/)`" "`\n(●_●)`" "`\n💖<\\  *Tapi Bo'ong`")


@app.on_message(filters.command("santet"))
async def santet(client: Client, message: Message):
    typew = await eor(message, text="`Mengaktifkan Perintah Santet Online....`")
    await asyncio.sleep(2)
...
/syg or /hack - Coba sendiri.

/hug or /bomb - Coba sendiri.

/brain or /kontol - Coba sendiri.

/penis or /hmm - Coba sendiri.

/tembak or /bundir - Coba sendiri.

/helikopter or /y - Coba sendiri.

/love or /awk - Coba sendiri.

/nah or /ajg - Coba sendiri.

/kocok or /ahh - Coba sendiri.

/ding or /gang - Coba sendiri.

/loveyou - Coba sendiri.
"""
