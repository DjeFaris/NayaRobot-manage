...
from Naya.utils import formatter
...
from Naya.utils.functions import extract_user, extract_user_and_reason, restart
...
@app.on_message(filters.command("mgban") & SUDOERS)
@capture_err
...
@app.on_message(filters.command("bd") & SUDOERS)
@capture_err
