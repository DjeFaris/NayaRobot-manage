...
class Log:
    def __init__(self, save_to_file=False, file_name="naya.logs"):
...
if not SESSION:
    ...
    app2 = Client(
        name="userbot", api_id=API_ID, api_hash=API_HASH, session_string=SESSION
    )
...
app = Client("naya", bot_token=BOT_TOKEN, api_id=API_ID, api_hash=API_HASH)
